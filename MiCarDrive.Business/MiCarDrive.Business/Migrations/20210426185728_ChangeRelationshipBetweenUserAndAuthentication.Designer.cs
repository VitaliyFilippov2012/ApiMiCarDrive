...
namespace DBContext.Migrations
{
    ...
    [Migration("20210426185728_ChangeRelationshipBetweenUserAndAuthentication")]
    partial class ChangeRelationshipBetweenUserAndAuthentication
    {
            ...
            modelBuilder.Entity("DBContext.Models.Authentication", b =>
                {
                    ...
                    b.HasIndex(new[] { "Login" }, "UQ__LOGIN_TY__D9C1FA00C38D47B8")
                        .IsUnique();
            ...
            modelBuilder.Entity("DBContext.Models.User", b =>
                {
                    ...
                    b.HasOne("DBContext.Models.Authentication", "Authentication")
                        .WithOne("User")
                        .HasForeignKey("DBContext.Models.User", "UserId")
